            ...
            <div className="row">
              <div className="col-xl-9 col-lg-11 col-md-8 m-auto">
                ...
                <p
                  ...
                  data-aos-delay="100"
                >
                  Deski delivered blazing fast performance, striking word
                  solution
                </p>
              </div>
            </div>
              ...
              <div className="row align-items-center">
                ...
                >
                  <div className="screen-container">
                    <Image
                      ...
                      src="/images/assets/screen_24.png"
                      alt="screen"
                    />
                  </div>
                  {/*  /.screen-container */}
                ...
                >
                  <div className="text-wrapper ps-xl-5">
                    ...
                    <p>
                      Commonly used in the graphic, prit quis & publishing
                      indust for previewing lorem visual mockups.
                    </p>
                  </div>
                  {/* /.text-wrapper */}
                </div>
